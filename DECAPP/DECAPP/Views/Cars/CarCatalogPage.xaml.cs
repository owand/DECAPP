    ...
    public partial class CarCatalogPage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new CarList();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                if (viewModel.GetSelectHostItem() != null)
                {
                    ...
                    viewModel.SelectHostItem.CARNAME = viewModel.SelectItem.CARNAME;
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new CarModel()
                    {
                        TYPEID = viewModel.TypeList[picTYPENAME.SelectedIndex].TYPEID,
                        CARNAME = viewModel.SelectItem.CARNAME,
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new CarSubModel()
                    {
                        CARID = viewModel.NewHostItem != null ? viewModel.NewHostItem.CARID : viewModel.SelectHostItem.CARID,
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    viewModel.SelectItem = viewModel.NewJoinItem != null ? viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.NewHostItem.CARID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.SelectHostItem.CARID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
