    ...
    public partial class CarTypePage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new CarType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new CarTypeModel() // Данные для новой основной коллекции
                    {
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new CarTypeSubModel()
                    {
