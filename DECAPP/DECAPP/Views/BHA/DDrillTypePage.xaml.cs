...
namespace DECAPP.Views.BHA
{
    ...
    public partial class DDrillTypePage : ContentPage
    {
        private DDrillType viewModel;

        public DDrillTypePage()
        {
            InitializeComponent();
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new DDrillType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new DDrillTypeModel() // Данные для новой основной коллекции
                    {
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new DDrillTypeSubModel()
                    {
