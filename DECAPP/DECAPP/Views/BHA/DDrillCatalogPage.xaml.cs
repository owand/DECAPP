...
namespace DECAPP.Views.BHA
{
    ...
    public partial class DDrillCatalogPage : ContentPage
    {
        private DDrillList viewModel;

        public DDrillCatalogPage()
        {
            InitializeComponent();
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new DDrillList();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                if (viewModel.GetSelectHostItem() != null)
                {
                    ...
                    viewModel.SelectHostItem.DDNAME = viewModel.SelectItem.DDNAME;
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new DDrillModel()
                    {
                        TYPEID = viewModel.TypeList[picTYPENAME.SelectedIndex].TYPEID,
                        DDNAME = viewModel.SelectItem.DDNAME,
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new DDrillSubModel()
                    {
                        DDID = viewModel.NewHostItem != null ? viewModel.NewHostItem.DDID : viewModel.SelectHostItem.DDID,
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    viewModel.SelectItem = viewModel.NewJoinItem != null ? viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.NewHostItem.DDID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.SelectHostItem.DDID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
