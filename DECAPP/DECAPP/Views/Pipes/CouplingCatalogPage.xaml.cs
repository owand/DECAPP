...
namespace DECAPP.Views.Pipes
{
    ...
    public partial class CouplingCatalogPage : ContentPage
    {
        private CouplingList viewModel;
        public CouplingCatalogPage()
        {
            InitializeComponent();
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new CouplingList();
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                viewModel.SelectItem.PIPESTYPEID = viewModel.TypePipesList[picPIPESTYPE.SelectedIndex].PIPESTYPEID;
                viewModel.SelectItem.PIPESOD = viewModel.PipesODList[picPIPESOD.SelectedIndex].PIPESOD;
                ...
                {
                    viewModel.SelectItem = viewModel.NewItem != null ? viewModel.Collection.FirstOrDefault(a => a.COUPLINGID == viewModel.NewItem.COUPLINGID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.COUPLINGID == viewModel.SelectItem.COUPLINGID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
