...
namespace DECAPP.Views.Pipes
{
    ...
    public partial class SteelCatalogPage : ContentPage
    {
        private SteelList viewModel;

        public SteelCatalogPage()
        {
            InitializeComponent();
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new SteelList();
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    viewModel.SelectItem = viewModel.NewItem != null ? viewModel.Collection.FirstOrDefault(a => a.STEELID == viewModel.NewItem.STEELID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.STEELID == viewModel.SelectItem.STEELID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
