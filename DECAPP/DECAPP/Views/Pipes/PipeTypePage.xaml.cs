...
namespace DECAPP.Views.Pipes
{
    ...
    public partial class PipeTypePage : ContentPage
    {
        private PipesType viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new PipesType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new PipesTypeModel() // Данные для новой основной коллекции
                    {
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new PipesTypeSubModel()
                    {
