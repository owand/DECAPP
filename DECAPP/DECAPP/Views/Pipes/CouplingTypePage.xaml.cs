...
namespace DECAPP.Views.Pipes
{
    ...
    public partial class CouplingTypePage : ContentPage
    {
        private CouplingType viewModel;

        public CouplingTypePage()
        {
            InitializeComponent();
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new CouplingType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new CouplingTypeModel() // Данные для новой основной коллекции
                    {
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new CouplingTypeSubModel()
                    {
