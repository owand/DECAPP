...
namespace DECAPP.Views.Rock
{
    ...
    public partial class RockRangPage : ContentPage
    {
        private RockRang viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new RockRang();
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    viewModel.SelectItem = viewModel.NewItem != null ? viewModel.Collection.FirstOrDefault(a => a.ROCKRANGID == viewModel.NewItem.ROCKRANGID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.ROCKRANGID == viewModel.SelectItem.ROCKRANGID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
