...
namespace DECAPP.Views.Rock
{
    ...
    public partial class RockTypePage : ContentPage
    {
        private RockType viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new RockType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new RockTypeModel() // Данные для новой основной коллекции
                    {
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new RockTypeSubModel()
                    {
