...
namespace DECAPP.Views.Equipment
{
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class UnitPage : ContentPage
    {
        private UnitList viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new UnitList();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                if (viewModel.GetSelectHostItem() != null)
                {
                    ...
                    viewModel.SelectHostItem.UNITNAME = viewModel.SelectItem.UNITNAME;
                    viewModel.SelectHostItem.WIDTH = viewModel.SelectItem.WIDTH;
                    viewModel.SelectHostItem.HEIGHT = viewModel.SelectItem.HEIGHT;
                    viewModel.SelectHostItem.LENGTH = viewModel.SelectItem.LENGTH;
                    viewModel.SelectHostItem.MASS = viewModel.SelectItem.MASS;
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new UnitModel()
                    {
                        TYPEID = viewModel.TypeList[picTYPENAME.SelectedIndex].TYPEID,
                        UNITNAME = viewModel.SelectItem.UNITNAME,
                        WIDTH = viewModel.SelectItem.WIDTH,
                        HEIGHT = viewModel.SelectItem.HEIGHT,
                        LENGTH = viewModel.SelectItem.LENGTH,
                        MASS = viewModel.SelectItem.MASS,
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                if (viewModel.GetSelectSubItem() != null)
                {
                    ...
                    viewModel.SelectSubItem.FEATURE = viewModel.SelectItem.FEATURE;
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new UnitSubModel()
                    {
                        UNITID = viewModel.NewHostItem != null ? viewModel.NewHostItem.UNITID : viewModel.SelectHostItem.UNITID,
                        FEATURE = viewModel.SelectItem.FEATURE,
        ...
        private async void OnSave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    viewModel.SelectItem = viewModel.NewJoinItem != null ? viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.NewHostItem.UNITID) :
                                                                           viewModel.Collection.FirstOrDefault(a => a.ID == viewModel.SelectHostItem.UNITID);
                    MasterContent.ScrollTo(viewModel.SelectItem, ScrollToPosition.Center, true); // Прокручиваем Scroll до активной записи.
                }
