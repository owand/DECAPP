...
namespace DECAPP.Views.Equipment
{
    ...
    public partial class RigTypePage : ContentPage
    {
        private RigType viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new RigType();
        ...
        private async Task SaveHostItem()
        {
            try
            {
                if (viewModel.GetSelectHostItem() != null)
                {
                    ...
                    viewModel.SelectHostItem.TONNAGE = viewModel.SelectItem.TONNAGE;
                ...
                else
                {
                    ...
                    viewModel.NewHostItem = new RigTypeModel() // Данные для новой основной коллекции
                    {
                        TYPENAME = viewModel.SelectItem.TYPENAME,
                        TONNAGE = viewModel.SelectItem.TONNAGE,
        ...
        private async Task SaveSubItem()
        {
            try
            {
                ...
                else
                {
                    ...
                    viewModel.NewSubItem = new RigTypeSubModel()
                    {
