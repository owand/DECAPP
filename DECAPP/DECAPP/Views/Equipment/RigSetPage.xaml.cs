...
namespace DECAPP.Views.Equipment
{
    ...
    public partial class RigSetPage : ContentPage
    {
        private RigSetList viewModel;
        ...
        protected override async void OnAppearing()
        {
            ...
            try
            {
                ...
                BindingContext = viewModel = viewModel ?? new RigSetList();
        ...
        private async void OnFilterGroup(object sender, EventArgs e)
        {
            await RefreshListView(); // Обновление записей в ListView Collection
        }

        // Очищаем фильтр.
        private void OnCancelFilterGroup(object sender, EventArgs e)
        {
            picFILTERGROUP.SelectedIndex = -1;
        }
        ...
        private void OnSave(object sender, EventArgs e)
        {
            try
            {
                viewModel.SelectItem.TYPEID = viewModel.TypeList[picRIGTYPE.SelectedIndex].TYPEID;
                viewModel.SelectItem.GROUPID = viewModel.GroupList[picUNITGROUP.SelectedIndex].GROUPID;
                viewModel.SelectItem.UNITID = viewModel.UnitList[picUNITNAME.SelectedIndex].UNITID;
        ...
        private async Task RefreshListView()
        {
            try
            {
                ...
                viewModel.Collection = viewModel.GetCollection(picFILTERTYPE.SelectedIndex < 0 ? null : viewModel.TypeList?[picFILTERTYPE.SelectedIndex].TYPEID.ToString(),
                                                               picFILTERGROUP.SelectedIndex < 0 ? null : viewModel.GroupList?[picFILTERGROUP.SelectedIndex].GROUPID.ToString());
